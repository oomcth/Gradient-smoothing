...
matplotlib.use("TkAgg")  # sous mac/linux/windows avec Tkinter


# -------------------------------------------------------
#  Environnement de pushing avec ressort
# -------------------------------------------------------
class PushingEnv(nn.Module):
    ...
    def simulate(self, u_seq, x1_0, v1_0, x2_0, v2_0):
        """
        Fait avancer la simulation et enregistre la trajectoire.
        """
        x1, v1 = x1_0, v1_0
        x2, v2 = x2_0, v2_0
...
H = env.H
u_seq = torch.zeros(H, requires_grad=True)  # pas de poussée initiale
